...
if ($con) {
  ...
  if (isset($_POST['export'])) {
    $filename = "Medicines Stock " . date('Ymdhis') . ".xls";
...
<body>
  ...
  <div class="container-fluid">
    <div class="container">
      ...
      createHeader('shopping-bag', 'Manage Item Stock', 'Manage Existing Item Stock');
      ?>
      <!-- header section end -->
      ...
      <div class="row">
        ...
        <div class="col-md-12 form-group form-inline">
          ...
          &emsp;<button class="btn btn-success font-weight-bold" onclick="cancel();"><i class="fa fa-refresh"></i></button>&emsp; &emsp;
          ...
          <form method="post" enctype="multipart/form-data">
            <input type="file" name="exceldata" accept=".xlsx, .xls">
            <input type="submit" name="import" value="Import to Excel" class="btn btn-success">&nbsp;&nbsp;
            ...
            <table class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th style="width: 14%;display: none;">Generic Name</th>
                  <th style="width: 10%;">Batch ID</th>
                  <!--<th style="width: 8%;display: none;">Ex. Date (mm/yy)</th> -->
