...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 08, 2024 at 12:19 PM
...
CREATE TABLE IF NOT EXISTS `admin_credentials` (
  ...
  `ADDRESS` varchar(50) COLLATE utf16_bin DEFAULT NULL,
  `EMAIL` varchar(50) COLLATE utf16_bin DEFAULT NULL,
  `CONTACT_NUMBER` varchar(11) COLLATE utf16_bin DEFAULT NULL,
  `IS_LOGGED_IN` varchar(11) COLLATE utf16_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `COUNTRY` varchar(100) COLLATE utf16_bin NOT NULL,
  `VEHICLE_NUMBER` varchar(20) COLLATE utf16_bin DEFAULT NULL,
  `GST_NUMBER` varchar(100) COLLATE utf16_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf16 COLLATE=utf16_bin;

--
-- Dumping data for table `customers`
--

INSERT INTO `customers` (`ID`, `NAME`, `CONTACT_NUMBER`, `ADDRESS`, `STATE`, `COUNTRY`, `VEHICLE_NUMBER`, `GST_NUMBER`) VALUES
...
(40, 'Kirk Dixon', '3758974544', 'Laboris Consectetur ', '', '', '486', '280'),
(41, 'Hayfa Harvey', '5792345896', 'Cumque Ullamco Cupid', '', '', '870', '993'),
(42, 'Anne Payne', '3078965478', 'Expedita Elit Est V', '', '', '148', '622'),
(43, 'Hoyt Case', '4541234785', 'Molestiae Blanditiis', '', '', '891', '772'),
(44, 'Ferdinand Valenzuela', '3997896547', 'Enim Quasi Officia S', '', '', '848', '103'),
(45, 'Stacy Alford', '7747894561', 'Tempore Non Dolorum', '', '', '696', '954'),
(46, 'Josiah Sawyer', '8807894521', 'Est Consequatur Cil', '', '', '227', '669'),
(47, 'Isabella Bailey', '4389784562', 'Ut In Dolore Numquam', '', '', '452', '756'),
(48, 'Stuart Rowland', '9787894561', 'Deleniti Aliquip Non', '', '', '671', '330'),
(49, 'Chadwick Park', '7751234567', 'Qui Distinctio Eius', '', '', '299', '863'),
(52, 'Dolan Morrison', '8797894562', 'Irure In Sed Est Sin', '', '', '487', '472'),
(53, 'Mannix Frazier', '2587894564', 'Id Quo Fuga Ullamc', '', '', '456', '41'),
(54, 'Tad Finch', '3231237488', 'Obcaecati Mollitia A', '', '', '54', '962'),
(55, 'Eden Sloan', '7515689784', 'Magnam Eu Esse Esse', '', '', '693', '935'),
(56, 'Acton Horton', '7305235681', 'Sed Rerum Doloremque', '', '', '817', '653'),
(57, 'Hamish Rose', '3885237854', 'Unde Cum Cumque Sapi', '', '', '123', '606'),
(58, 'Dillon Talley', '4487895478', 'Id Quia Voluptas Id ', '', '', '389', '707'),
(59, 'Lucas Irwin', '3418795241', 'Et Voluptate Qui Tem', '', '', '60', '487'),
(60, 'Lucas Irwin', '3418795281', 'Et Voluptate Qui Tem', 'Abc', 'Xyz', '60', '487'),
(61, 'Henry Emerson', '5678956547', 'Doloremque Reprehend', '', '', '774', '92'),
(63, 'Cynthia Gaines', '7896547862', 'Fugiat Autem Sapien', '', '', '979', '415'),
(66, 'Roth Garrett', '6867895426', 'Magni Nihil Eos Del', 'Quia Delectus Non V', 'Consequat Possimus', '876', '320');
...
CREATE TABLE IF NOT EXISTS `invoices` (
  ...
  `TOTAL_TAX` int NOT NULL DEFAULT '18',
...
(187, 'Judith Sellers', '911', '', 'Keane Nicholson'),
(188, 'Rae Hoover', '101', '', 'Veda Gates');
...
INSERT INTO `suppliers` (`ID`, `NAME`, `EMAIL`, `CONTACT_NUMBER`, `ADDRESS`, `STATE`, `COUNTRY`, `VEHICLE_NUMBER`, `GST_NUMBER`) VALUES
(2, 'Tattva', 'tattvabangalore1@gmail.com', '9342411919', 'Embassy Complex Bangalore 560027', '', '', '', '29AEEPB1993F1ZK'),
(3, 'Harlan Reeves', 'peqovivy@mailinator.com', '9594578963', 'Dolor Est Laudantium', '', '', '933', '573'),
(4, 'Quemby Duffy', 'wehewyrazu@mailinator.com', '5007894561', 'Sed Maiores Veniam ', '', '', '181', '898'),
(5, 'Fletcher Britt', 'rufutenog@mailinator.com', '9807894562', 'Enim Eveniet Omnis ', 'Aliqua Nemo Consequ', 'Eligendi Quia Cillum', '203', '377'),
(6, 'Susan Jefferson', 'dexymyf@mailinator.com', '9267894562', 'Quia Dolorem Accusam', 'Amet Eveniet Place', 'Eveniet Dolorem Dol', '540', '444');
COMMIT;
