    ...
    for ($i = 1; $i < $sheetCount; $i++) {
      if ($con) {
        ...
        if ($existingRecord) {
          ...
          $sql = "insert into customers (NAME,CONTACT_NUMBER,ADDRESS,STATE,COUNTRY,VEHICLE_NUMBER,GST_NUMBER) 
        ...
        // $sql = "insert into customers (NAME,CONTACT_NUMBER,ADDRESS,VEHICLE_NUMBER,GST_NUMBER) values ('" . $spreadSheetAry[$i][0] . "','" . $spreadSheetAry[$i][1] . "','" . $spreadSheetAry[$i][2] . "','" . $spreadSheetAry[$i][3] . "','" . $spreadSheetAry[$i][4] . "')";
