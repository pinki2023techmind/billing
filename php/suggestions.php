<?php
  ...
  if($con) {
    ...
    if(isset($_GET['action']) && $_GET['action'] == "customer_state")
      getValue($con, $_GET['action'], "STATE");

      if(isset($_GET['action']) && $_GET['action'] == "customer_country")
      getValue($con, $_GET['action'], "COUNTRY");
    ...
    if(isset($_GET['action']) && $_GET['action'] == "vehicles_number")
      getValue($con, $_GET['action'], "VEHICLE_NUMBER");

    if(isset($_GET['action']) && $_GET['action'] == "gsts_number")
      getValue($con, $_GET['action'], "NUMBER");
  }
